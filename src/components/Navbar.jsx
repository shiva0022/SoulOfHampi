  ...
  return (
    <nav className="navbar flex justify-between items-center p-4 text-[#f5f1e8] shadow-2xl bg-gradient-to-r from-[#2d1f0f] via-[#3d2914] to-[#4a3420] backdrop-blur-[10px] h-16 border-b border-[#6b5b4b]">
      <div className="logo flex gap-2 items-center">
        <span>
          <img src="/nav-logo.png" alt="logo" className="w-8 h-8" />
        </span>
        <span className="font-bold text-xl text-[#f5f1e8] tracking-wide">SoulOfHampi</span>
      </div>
      ...
      <div className="cart flex gap-3 items-center">
        <span className="relative group">
          ...
          />
          <span className="absolute -top-2 -right-2 bg-[#d4c5a0] text-[#3d2914] text-xs rounded-full w-5 h-5 flex items-center justify-center font-bold">3</span>
        </span>
        <span className="relative group">
          <BiBookmarkHeart
            size={24}
            className="cursor-pointer text-[#f5f1e8] hover:text-[#d4c5a0] transition-colors duration-300"
          />
          <span className="absolute -top-2 -right-2 bg-[#d4c5a0] text-[#3d2914] text-xs rounded-full w-5 h-5 flex items-center justify-center font-bold">5</span>
        </span>
        <button
          type="button"
